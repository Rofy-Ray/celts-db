            ...
            <table class="table table-striped">
                  ...
                  if ($result = mysqli_query($link, $sql_query )) {
                        while ($theRow = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                          ...
                          "</td><td><a href='edit_staff.php?id=" . $theRow['Staff_ID'] . "'>
                          <button class='btn btn-info btn-xs'>Edit</button></a></td>",
                          "<td><a href='del_staff.php?id=" . $theRow['Staff_ID'] . "'
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label>Volunteer Date</label>
                    <p>
                      <div class="bfh-datepicker" data-format="y-m-d" data-date="today" style="color:#000000;"></div>
                    </p>
                </div>
                <div class="form-group">
